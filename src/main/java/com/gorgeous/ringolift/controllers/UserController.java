...
public class UserController {
    ...
    public ResponseEntity<ResponseObject> updateUser(
            ...
            @Valid @RequestBody UserRequest userRequest) throws DataNotFoundException {
    ...
    public ResponseEntity<ResponseObject> createChapterProgress(
        ...
        ChapterProgressResponse chapterProgressResponse = userService
                .createChapterProgress(chapterProgressRequest);
        return ResponseEntity.status(HttpStatus.CREATED).body(
                ResponseObject.builder()
    ...
    public ResponseEntity<ResponseObject> getChapterProgress(
            @PathVariable("user_id") Long userId,
            @PathVariable("chapter_id") Long chapterId) throws DataNotFoundException {
        ChapterProgressResponse chapterProgressResponse = userService.getChapterProgress(userId,
                chapterId);
        return ResponseEntity.ok(
                ResponseObject.builder()
    ...
    public ResponseEntity<ResponseObject> getChapterProgressByUserId(
            @PathVariable("user_id") Long userId) {
        List<ChapterProgressResponse> chapterProgressResponseList = userService
                .getChapterProgressByUserId(userId);
        return ResponseEntity.ok(
                ResponseObject.builder()
    ...
    public ResponseEntity<ResponseObject> updateChapterProgress(
            ...
            @Valid @RequestBody ChapterProgressRequest chapterProgressRequest)
            throws DataNotFoundException {
        ChapterProgressResponse chapterProgressResponse = userService.updateChapterProgress(userId,
                chapterId,
    ...
    public ResponseEntity<ResponseObject> deleteChapterProgressByUserId(
            @PathVariable("user_id") Long userId) {
    ...
    public ResponseEntity<ResponseObject> createLessonProgress(
        ...
        LessonProgressResponse lessonProgressResponse = userService.createLessonProgress(
    ...
    public ResponseEntity<ResponseObject> getLessonProgress(
            @PathVariable("user_id") Long userId,
            @PathVariable("lesson_id") Long lessonId) throws DataNotFoundException {
        LessonProgressResponse lessonProgressResponse = userService.getLessonProgress(userId,
                lessonId);
        return ResponseEntity.ok(
                ResponseObject.builder()
    ...
    public ResponseEntity<ResponseObject> getLessonProgressByUserId(
            @PathVariable("user_id") Long userId) {
        List<LessonProgressResponse> lessonProgressResponseList = userService.getLessonProgressByUserId(
                userId);
        return ResponseEntity.ok(
                ResponseObject.builder()
    ...
    public ResponseEntity<ResponseObject> updateLessonProgress(
            ...
            @Valid @RequestBody LessonProgressRequest lessonProgressRequest)
            throws DataNotFoundException {
        LessonProgressResponse lessonProgressResponse = userService.updateLessonProgress(userId,
                lessonId,
                lessonProgressRequest);
        return ResponseEntity.ok(
                ResponseObject.builder()
    ...
    public ResponseEntity<ResponseObject> deleteLessonProgressByUserId(
            @PathVariable("user_id") Long userId) {
    ...
    public ResponseEntity<ResponseObject> getUserGenderById(@PathVariable("gender_id") Long id)
            throws DataNotFoundException {
